...
fullFeatureDF = spark.read.format("parquet").option("header", True).option("inferSchema", True).load("PreProcessed3000000.parquet").coalesce(parts).persist()
...
if len (sys.argv) < 2:
    ...
    song1 = "50lsSO6eOLUpMz0YCCEIyx"
    song2 = "57JW3lzYtHhtNXBVUk4Srg"
