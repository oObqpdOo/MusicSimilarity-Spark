...
for i in list1l: 
    outname = "results/covers80/" + str(i).replace('.mp3', '').replace('music/', '').replace("[","").replace("]","").rpartition('/')[0] + "___" + str(i).replace('.mp3', '').replace('music/', '').replace("[","").replace("]","").rpartition('/')[2] + ".csv"
    print outname    
