...
def get_nearest_neighbors(song, outname):
    ...
    mergedSim = mergedSim.withColumn('aggregated', (mergedSim.scaled_bh + mergedSim.scaled_mfcc + mergedSim.scaled_corr + mergedSim.scaled_levenshtein + mergedSim.scaled_rp + mergedSim.scaled_skl) / 6)
...
get_nearest_neighbors(song, "Chandelier.csv")

song = "music/Small Cover Song Library/ACDC Cover - TNT.mp3"
get_nearest_neighbors(song, "TNT.csv")

song = "music/Small Cover Song Library/Rachmaninoff - Op 3_ No 2 by Idil Biret.mp3"
get_nearest_neighbors(song, "Rachmaninoff.csv")

song = "music/Small Cover Song Library/Serj Tankian - Empty Walls (Orchestra).mp3"
get_nearest_neighbors(song, "Serj.csv")

song = "music/Small Cover Song Library/Dark Tranquillity - Punish My Heaven.mp3"
get_nearest_neighbors(song, "Punish.csv")

song = "music/Small Cover Song Library/Fuer Elise 1.mp3"
get_nearest_neighbors(song, "Elise.csv")
