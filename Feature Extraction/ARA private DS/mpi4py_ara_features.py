...
gc.enable()
filelist = []
for filename in Path('/beegfs/ja62lel/private/music').glob('**/*.mp3'):
    filelist.append(filename)
for filename in Path('/beegfs/ja62lel/private/music').glob('**/*.wav'):
    filelist.append(filename) 
for filename in Path('/beegfs/ja62lel/private/music').glob('**/*.aiff'):
    filelist.append(filename) 
for filename in Path('/beegfs/ja62lel/private/music').glob('**/*.flac'):
    filelist.append(filename) 
for filename in Path('/beegfs/ja62lel/private/music').glob('**/*.ogg'):
    filelist.append(filename)  
