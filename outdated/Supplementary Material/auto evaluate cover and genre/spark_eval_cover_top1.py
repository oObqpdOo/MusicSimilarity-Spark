...
for i in list1l[:]: 
    ...
    rddRes = rddDF.withColumn('newdist', (rddDF.chroma + rddDF.notes + rddDF.rp) / 3).select("id", "cover", "newdist").orderBy('newdist', ascending=True).limit(2)
    #rddRes.show()
...
reduced = resultreducekey.reduceByKey(lambda x, y: x + y)
reducedDF = spark.createDataFrame(reduced, ["original vs detected", "count"])
reducedDF.toPandas().to_csv("__cover_mfcc_notes_rp.csv", encoding='utf-8')
...
reduced = resultreducekey.reduceByKey(lambda x, y: x + y)
reducedDF = spark.createDataFrame(reduced, ["original vs detected", "count"])
reducedDF.toPandas().to_csv("__cover_notes.csv", encoding='utf-8')
...
reduced = resultreducekey.reduceByKey(lambda x, y: x + y)
reducedDF = spark.createDataFrame(reduced, ["original vs detected", "count"])
reducedDF.toPandas().to_csv("__cover_chroma_notes.csv", encoding='utf-8')
...
reduced = resultreducekey.reduceByKey(lambda x, y: x + y)
reducedDF = spark.createDataFrame(reduced, ["original vs detected", "count"])
reducedDF.toPandas().to_csv("__cover_chroma.csv", encoding='utf-8')
...
reduced = resultreducekey.reduceByKey(lambda x, y: x + y)
reducedDF = spark.createDataFrame(reduced, ["original vs detected", "count"])
reducedDF.toPandas().to_csv("__cover_notes_rp.csv", encoding='utf-8')
...
for i in list1l[:]: 
    ...
    rdd = rdd.map(lambda x: (x[0], x[1][0], x[1][1], x[1][2], x[1][3], x[1][4], x[1][5], x[1][6], x[1][7], x[1][8], x[1][9], x[1][10], x[1][11], x[1][12]))
    rddDF = spark.createDataFrame(rdd, ["cover","id","key","scale","bpm","rp","rh","bh","notes","chroma","skl","js","mfcc","agg"])
    rddRes = rddDF.withColumn('newdist', (rddDF.chroma + rddDF.js) / 2).select("id", "cover", "newdist").orderBy('newdist', ascending=True).limit(2)
    #rddRes.show()
    originalSong = rddRes.select("cover").limit(1).collect()[0]["cover"]
    originalID = rddRes.select("id").limit(1).collect()[0]["id"]
    #then drop row
...
reduced = resultreducekey.reduceByKey(lambda x, y: x + y)
reducedDF = spark.createDataFrame(reduced, ["original vs detected", "count"])
reducedDF.toPandas().to_csv("__cover_chroma_js.csv", encoding='utf-8')
...
for i in list1l[:]: 
    ...
    rdd = rdd.map(lambda x: (x[0], x[1][0], x[1][1], x[1][2], x[1][3], x[1][4], x[1][5], x[1][6], x[1][7], x[1][8], x[1][9], x[1][10], x[1][11], x[1][12]))
    rddDF = spark.createDataFrame(rdd, ["cover","id","key","scale","bpm","rp","rh","bh","notes","chroma","skl","js","mfcc","agg"])
    rddRes = rddDF.withColumn('newdist', (rddDF.chroma + rddDF.mfcc) / 2).select("id", "cover", "newdist").orderBy('newdist', ascending=True).limit(2)
    #rddRes.show()
    originalSong = rddRes.select("cover").limit(1).collect()[0]["cover"]
    originalID = rddRes.select("id").limit(1).collect()[0]["id"]
    #then drop row
...
reduced = resultreducekey.reduceByKey(lambda x, y: x + y)
reducedDF = spark.createDataFrame(reduced, ["original vs detected", "count"])
reducedDF.toPandas().to_csv("__cover_chroma_mfcc.csv", encoding='utf-8')
...
for i in list1l[:]: 
    ...
    rdd = rdd.map(lambda x: (x[0], x[1][0], x[1][1], x[1][2], x[1][3], x[1][4], x[1][5], x[1][6], x[1][7], x[1][8], x[1][9], x[1][10], x[1][11], x[1][12]))
    rddDF = spark.createDataFrame(rdd, ["cover","id","key","scale","bpm","rp","rh","bh","notes","chroma","skl","js","mfcc","agg"])
    rddRes = rddDF.withColumn('newdist', (rddDF.chroma + rddDF.rp) / 2).select("id", "cover", "newdist").orderBy('newdist', ascending=True).limit(2)
    #rddRes.show()
    originalSong = rddRes.select("cover").limit(1).collect()[0]["cover"]
    originalID = rddRes.select("id").limit(1).collect()[0]["id"]
    #then drop row
...
reduced = resultreducekey.reduceByKey(lambda x, y: x + y)
reducedDF = spark.createDataFrame(reduced, ["original vs detected", "count"])
reducedDF.toPandas().to_csv("__cover_chroma_rp.csv", encoding='utf-8')
...
for i in list1l[:]: 
    ...
    rdd = rdd.map(lambda x: (x[0], x[1][0], x[1][1], x[1][2], x[1][3], x[1][4], x[1][5], x[1][6], x[1][7], x[1][8], x[1][9], x[1][10], x[1][11], x[1][12]))
    rddDF = spark.createDataFrame(rdd, ["cover","id","key","scale","bpm","rp","rh","bh","notes","chroma","skl","js","mfcc","agg"])
    rddRes = rddDF.withColumn('newdist', (rddDF.chroma + rddDF.js  + rddDF.rp) / 3).select("id", "cover", "newdist").orderBy('newdist', ascending=True).limit(2)
    #rddRes.show()
    originalSong = rddRes.select("cover").limit(1).collect()[0]["cover"]
    originalID = rddRes.select("id").limit(1).collect()[0]["id"]
    #then drop row
...
reduced = resultreducekey.reduceByKey(lambda x, y: x + y)
reducedDF = spark.createDataFrame(reduced, ["original vs detected", "count"])
reducedDF.toPandas().to_csv("__cover_chroma_js_rp.csv", encoding='utf-8')
...
for i in list1l[:]: 
    ...
    rdd = rdd.map(lambda x: (x[0], x[1][0], x[1][1], x[1][2], x[1][3], x[1][4], x[1][5], x[1][6], x[1][7], x[1][8], x[1][9], x[1][10], x[1][11], x[1][12]))
    rddDF = spark.createDataFrame(rdd, ["cover","id","key","scale","bpm","rp","rh","bh","notes","chroma","skl","js","mfcc","agg"])
    rddRes = rddDF.withColumn('newdist', (rddDF.chroma + rddDF.mfcc  + rddDF.rp) / 3).select("id", "cover", "newdist").orderBy('newdist', ascending=True).limit(2)
    #rddRes.show()
    originalSong = rddRes.select("cover").limit(1).collect()[0]["cover"]
    originalID = rddRes.select("id").limit(1).collect()[0]["id"]
    #then drop row
...
reduced = resultreducekey.reduceByKey(lambda x, y: x + y)
reducedDF = spark.createDataFrame(reduced, ["original vs detected", "count"])
reducedDF.toPandas().to_csv("__cover_chroma_mfcc_rp.csv", encoding='utf-8')
...
for i in list1l[:]: 
    ...
    rdd = rdd.map(lambda x: (x[0], x[1][0], x[1][1], x[1][2], x[1][3], x[1][4], x[1][5], x[1][6], x[1][7], x[1][8], x[1][9], x[1][10], x[1][11], x[1][12]))
    rddDF = spark.createDataFrame(rdd, ["cover","id","key","scale","bpm","rp","rh","bh","notes","chroma","skl","js","mfcc","agg"])
    rddRes = rddDF.withColumn('newdist', (rddDF.chroma + rddDF.js + rddDF.rp + rddDF.rh + rddDF.bh + rddDF.skl + rddDF.notes + rddDF.mfcc) / 8).select("id", "cover", "newdist").orderBy('newdist', ascending=True).limit(2)
    #rddRes.show()
    originalSong = rddRes.select("cover").limit(1).collect()[0]["cover"]
    originalID = rddRes.select("id").limit(1).collect()[0]["id"]
    #then drop row
...
reduced = resultreducekey.reduceByKey(lambda x, y: x + y)
reducedDF = spark.createDataFrame(reduced, ["original vs detected", "count"])
reducedDF.toPandas().to_csv("__cover_allf.csv", encoding='utf-8')
...
for i in list1l[:]: 
    ...
    rdd = rdd.map(lambda x: (x[0], x[1][0], x[1][1], x[1][2], x[1][3], x[1][4], x[1][5], x[1][6], x[1][7], x[1][8], x[1][9], x[1][10], x[1][11], x[1][12]))
    rddDF = spark.createDataFrame(rdd, ["cover","id","key","scale","bpm","rp","rh","bh","notes","chroma","skl","js","mfcc","agg"])
    rddRes = rddDF.withColumn('newdist', (rddDF.rp) / 1).select("id", "cover", "newdist").orderBy('newdist', ascending=True).limit(2)
    #rddRes.show()
    originalSong = rddRes.select("cover").limit(1).collect()[0]["cover"]
    originalID = rddRes.select("id").limit(1).collect()[0]["id"]
    #then drop row
...
reduced = resultreducekey.reduceByKey(lambda x, y: x + y)
reducedDF = spark.createDataFrame(reduced, ["original vs detected", "count"])
reducedDF.toPandas().to_csv("__cover_rp.csv", encoding='utf-8')
...
for i in list1l[:]: 
    ...
    rdd = rdd.map(lambda x: (x[0], x[1][0], x[1][1], x[1][2], x[1][3], x[1][4], x[1][5], x[1][6], x[1][7], x[1][8], x[1][9], x[1][10], x[1][11], x[1][12]))
    rddDF = spark.createDataFrame(rdd, ["cover","id","key","scale","bpm","rp","rh","bh","notes","chroma","skl","js","mfcc","agg"])
    rddRes = rddDF.withColumn('newdist', (rddDF.mfcc + rddDF.js + rddDF.skl) / 3).select("id", "cover", "newdist").orderBy('newdist', ascending=True).limit(2)
    #rddRes.show()
    originalSong = rddRes.select("cover").limit(1).collect()[0]["cover"]
    originalID = rddRes.select("id").limit(1).collect()[0]["id"]
    #then drop row
...
reduced = resultreducekey.reduceByKey(lambda x, y: x + y)
reducedDF = spark.createDataFrame(reduced, ["original vs detected", "count"])
reducedDF.toPandas().to_csv("__cover_mfcc_js_skl.csv", encoding='utf-8')
...
for i in list1l[:]: 
    ...
    rdd = rdd.map(lambda x: (x[0], x[1][0], x[1][1], x[1][2], x[1][3], x[1][4], x[1][5], x[1][6], x[1][7], x[1][8], x[1][9], x[1][10], x[1][11], x[1][12]))
    rddDF = spark.createDataFrame(rdd, ["cover","id","key","scale","bpm","rp","rh","bh","notes","chroma","skl","js","mfcc","agg"])
    rddRes = rddDF.withColumn('newdist', (rddDF.chroma + rddDF.skl) / 2).select("id", "cover", "newdist").orderBy('newdist', ascending=True).limit(2)
    #rddRes.show()
    originalSong = rddRes.select("cover").limit(1).collect()[0]["cover"]
    originalID = rddRes.select("id").limit(1).collect()[0]["id"]
    #then drop row
...
reduced = resultreducekey.reduceByKey(lambda x, y: x + y)
reducedDF = spark.createDataFrame(reduced, ["original vs detected", "count"])
reducedDF.toPandas().to_csv("__cover_chroma_skl.csv", encoding='utf-8')
...
for i in list1l[:]: 
    ...
    rdd = rdd.map(lambda x: (x[0], x[1][0], x[1][1], x[1][2], x[1][3], x[1][4], x[1][5], x[1][6], x[1][7], x[1][8], x[1][9], x[1][10], x[1][11], x[1][12]))
    rddDF = spark.createDataFrame(rdd, ["cover","id","key","scale","bpm","rp","rh","bh","notes","chroma","skl","js","mfcc","agg"])
    rddRes = rddDF.withColumn('newdist', (rddDF.chroma + rddDF.skl  + rddDF.rp) / 3).select("id", "cover", "newdist").orderBy('newdist', ascending=True).limit(2)
    #rddRes.show()
    originalSong = rddRes.select("cover").limit(1).collect()[0]["cover"]
    originalID = rddRes.select("id").limit(1).collect()[0]["id"]
    #then drop row
...
reduced = resultreducekey.reduceByKey(lambda x, y: x + y)
reducedDF = spark.createDataFrame(reduced, ["original vs detected", "count"])
reducedDF.toPandas().to_csv("__cover_chroma_skl_rp.csv", encoding='utf-8')
