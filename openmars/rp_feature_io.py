...
class CSVFeatureWriter(FeatureWriter):
    ...
    def open(self,base_filename,ext,append=False):
        ...
        import openmars.unicsv # unicode csv library (installed via pip install unicsv)
        ...
        for e in ext:
            ...
            self.writer[e] = openmars.unicsv.UnicodeCSVWriter(self.files[e]) #, quoting=csv.QUOTE_ALL)
